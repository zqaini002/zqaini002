<p align="center">
  <img src="./assets/profile-banner.svg" alt="Sevyn developer profile" width="100%" />
</p>
...
<table>
  <tr>
    <td>
      ...
      <p>Developer tooling for safer coding-agent delivery and continuous improvement.</p>
...
<table>
  <tr>
    <td width="50%" valign="top">
      ...
      <p>Novel analysis for discovery, reading, and deeper content analysis.</p>
      <code>Java</code> <code>46 Stars</code>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/zqaini002/student-management">Student Management</a></h3>
      <p>Information management with authentication, courses, grades, and administration workflows.</p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A HarmonyOS application for setting, managing, and pursuing personal goals.</p>
      <code>ArkTS</code> <code>HarmonyOS</code> <code>5 Stars</code>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/zqaini002/weix">weix</a></h3>
      <p>A personal messaging automation experiment with LLM-powered replies and configurable skills.</p>
  ...
  <tr>
    <td width="50%" valign="top">
      ...
      <p>A deployable platform for agent orchestration, knowledge enhancement, tools, and governance.</p>
      <code>Java</code> <code>2 Stars</code>
    </td>
    <td width="50%" valign="top">
      <h3><a href="https://github.com/zqaini002/Travel-Assistant">Travel Assistant</a></h3>
      <p>A voice-driven travel planning assistant built on Open-AutoGLM.</p>
